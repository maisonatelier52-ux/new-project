                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-x-12 gap-y-20">
                    {cases.map((project, idx) => (
                        ...
                        >
                            ...
                            <button className="w-fit px-10 py-3.5 border border-white/20 text-[9px] font-bold uppercase tracking-[0.2em] hover:bg-white hover:text-black transition-all duration-300">
                                View Case Study
                            </button>
                        </motion.div>
                    ))}

        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
          ...
          <motion.div {...anim(0.35)} className="grid grid-cols-2 md:grid-cols-3 gap-x-12 lg:gap-x-32 gap-y-8 text-white">
            ...
            <div className="flex flex-col space-y-3">
              ...
              <Link href="/regions" className="text-[13px] hover:text-white/60 transition-colors decoration-white/30 underline-offset-4">Regions</Link>
              <Link href="/investors" className="text-[13px] hover:text-white/60 transition-colors decoration-white/30 underline-offset-4">Investors</Link>
              <Link href="/insights" className="text-[13px] hover:text-white/60 transition-colors decoration-white/30 underline-offset-4">Insights</Link>
            </div>
            {/* Col 2 */}
            <div className="flex flex-col space-y-3">
              ...
              <Link href="/technology" className="text-[13px] hover:text-white/60 transition-colors decoration-white/30 underline-offset-4">Technology</Link>
              <Link href="/case-studies-projects" className="text-[13px] hover:text-white/60 transition-colors decoration-white/30 underline-offset-4">Case Studies</Link>
              <Link href="/contact" className="text-[13px] hover:text-white/60 transition-colors decoration-white/30 underline-offset-4">Contact</Link>
            </div>
            {/* Col 3 */}
            <div className="flex flex-col space-y-3">
              <Link href="/operations" className="text-[13px] hover:text-white/60 transition-colors decoration-white/30 underline-offset-4">Operations</Link>
              <Link href="/esg" className="text-[13px] hover:text-white/60 transition-colors decoration-white/30 underline-offset-4">ESG</Link>
              <Link href="/team" className="text-[13px] hover:text-white/60 transition-colors decoration-white/30 underline-offset-4">Team</Link>
            </div>
          </motion.div>
        </div>
      </div>

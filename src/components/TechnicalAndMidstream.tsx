...
<div className="w-full pt-2 ">
      <div className=" mx-auto flex flex-col lg:flex-row gap-10">
        <motion.div 
          ...
          className="flex-1 border border-white/60 rounded-xl p-7 md:p-10 flex flex-col justify-between"
        >
          ...
          <h2 className="text-4xl text-start md:text-[40px] max-w-140 font-bold leading-none mb-6">
            Digital Midstream
            Infrastructure
          </h2>
          ...
          <p className="text-whtie/90 text-start text-[12px] max-w-150 leading-tight  mb-8">
        ...
        <motion.div 
          ...
          className="w-full lg:w-[420px] border border-white/60 rounded-xl p-7 md:p-10 flex flex-col"
        >
          <div className="mb-6 opacity-80">
            <Image
          ...
          <h3 className="text-[30px] text-start font-bold leading-none mb-6">
            Asset Integrity &
            Compliance
          </h3>

          <p className="text-white/90 text-start text-[12px] leading-tight">
    ...
    <motion.div 
      ...
      className="pt-10"
    >
      <div className="mx-auto bg-[#1a1a1a] rounded-xl p-7 md:p-10 flex flex-col lg:flex-row gap-12">
        {/* LEFT CONTENT */}
        <div className="flex-1 pt-5 ">
          {/* Small Label */}
          <p className="text-[17px] tracking-[0.25em] text-white/60 mb-6">
            SAFETY AT SCALE
          </p>

          {/* Heading */}
          <h2 className="text-xl md:text-2xl text-white lg:text-[40px] leading-none font-extrabold mb-6">
            The Orinox Standard
          ...
          {/* Description */}
          <p className="text-white/90 text-[12px] leading-tight max-w-[420px]">

...
export default function FutureCapabilities() {
  return (
    ...
    <div className="absolute top-1/2 w-110 -translate-y-1/2 left-6 sm:left-10 lg:left-25 z-20 space-y-5 max-w-xs sm:max-w-md lg:max-w-xl text-white flex flex-col">      
      <div>

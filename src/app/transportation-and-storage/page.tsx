      ...
      <div className="absolute bottom-25 w-150 left-6 sm:left-10 lg:left-16 z-20 space-y-5 max-w-xs sm:max-w-md lg:max-w-xl text-white flex flex-col">
        ...
        <div>
          ...
          <p className="text-[12px] text-white/50 leading-tight">
            We offer multiple services, depending on the product and location,
            including setting up of pipelines, and transportation by rail, road,
        ...
        <div>
          ...
          <p className="text-[12px] text-white/50 leading-tight">
            Holding of raw materials like crude oil and natural gas, and
            finished products (refined petroleum products or liquified
            naturalgas) in facilities such as tanks, mounded storage vessels, or
            underground reservoirs, require the most trustworthy and reliable
            specialists. At Orinox, we ensure nothing is left to chance.
          </p>
        </div>
      </div>
    </main>

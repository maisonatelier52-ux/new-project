                    ...
                    <motion.div {...anim(0.1)} className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-32">
                        <div className="max-w-md">
                            <p className="text-white/60 text-[13px] md:text-[14px] leading-relaxed font-light">
                                Orinox Holding manages an integrated delivery ecosystem supported by experienced professionals, senior engineers, specialist consultants, and trusted contractor partners.
                            </p>
                        </div>
                        <div className="max-w-md">
                            <p className="text-white/60 text-[13px] md:text-[14px] leading-relaxed font-light">
                                Orinox Holding was formed to advance the strategic development and efficient execution of capital-intensive projects and essential infrastructure upgrades.
                            </p>
                        </div>
                    </motion.div>
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
                        ...
                        <motion.div {...anim(0.35)} className="grid grid-cols-2 md:grid-cols-3 gap-x-12 lg:gap-x-32 gap-y-8 text-white">
                            <div className="flex flex-col space-y-3">
                                ...
                                <Link href="/" className="text-[13px] hover:text-white/60 transition-colors">Investors</Link>
                            </div>
                            <div className="flex flex-col space-y-3">
                                ...
                                <Link href="/contracts" className="text-[13px] hover:text-white/60 transition-colors border-b border-white/30">Contracts</Link>
                            </div>
                            <div className="flex flex-col space-y-3">
                ...
                <div className="relative z-20 mt-12 md:mt-16">
                    ...
                    <motion.div {...anim(0.6)} className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-8">
                        <div>
                            ...
                            <p className="text-[12px] text-white/70 leading-relaxed font-light uppercase">Level 28, 52 Lime Street,<br />London, EC3M 7AF</p>
                        </div>
                        <div>
                            <h5 className="text-[13px] font-bold text-white mb-1">United Arab Emirates</h5>
                            <p className="text-[12px] text-white/70 leading-relaxed font-light uppercase">Vila 145, Al Manara Street,<br />Al Safa 2, Dubai</p>
                        </div>
                        <div>
                            <h5 className="text-[13px] font-bold text-white mb-1">Venezuela</h5>
                            <p className="text-[12px] text-white/70 leading-relaxed font-light uppercase">Edificio Epsilon CIIP,<br />Caracas 1060</p>
                        </div>
                        <div>
                            <h5 className="text-[13px] font-bold text-white mb-1">Madrid</h5>
                            <p className="text-[12px] text-white/70 leading-relaxed font-light uppercase">Plaza de la Independencia 8,<br />Piso 3, Madrid</p>
                        </div>
                    </motion.div>
                </div>

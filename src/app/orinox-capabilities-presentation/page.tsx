  ...
  return (
    <div className="flex flex-col bg-black">
      ...
      */}
      ...
      {/* 14. FOOTER */}
      <footer className="relative min-h-screen w-full bg-black overflow-hidden px-6 md:px-32 py-20 flex flex-col justify-end">
        <img
        ...
        <div className="relative z-20 flex flex-col space-y-16 md:space-y-24">

          {/* Top content: Description */}
          <motion.div {...anim(0.1)} className="flex flex-col lg:flex-row justify-between items-start gap-12 lg:gap-16">
          ...
          <div className="space-y-12">
            <motion.div {...anim(0.3)} className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-12 lg:gap-16">
              <div className="flex items-center">
                <img src="/images/orinox-white-logo.png" alt="Orinox" className="h-12 md:h-28 w-auto object-contain opacity-90" />
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 md:gap-12 lg:gap-24 text-white w-full lg:w-auto">
            ...
            <motion.div {...anim(0.5)} className="pt-8 border-t border-white/20 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] md:text-[12px] tracking-widest text-white/30 uppercase text-center md:text-left">

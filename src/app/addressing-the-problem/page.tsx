...
export default function CurrentCapabilities() {
  ...
  bg-[radial-gradient(ellipse_at_bottom_left,rgba(0,0,0,0.55)_0%,rgba(0,0,0,0.35)_30%,rgba(0,0,0,0.15)_45%,transparent_60%)]">
    ...
    <div className="absolute bottom-25 -translate-y-1/2 left-6 sm:left-10 lg:left-25 z-20 space-y-5 max-w-xs sm:max-w-md lg:max-w-xl text-white flex flex-col">  
          <div>

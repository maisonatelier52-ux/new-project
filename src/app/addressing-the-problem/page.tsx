...
Inefficient, High-Emission Field Development
        ...
        {/* Description */}
        <p className="text-[13px] md:text-[12px] text-white">Traditional drilling and midstream development is siloed, inefficient, and often wasteful.</p>
        <div>
         <p className="text-[13px] md:text-[12px] text-white leading-tight">

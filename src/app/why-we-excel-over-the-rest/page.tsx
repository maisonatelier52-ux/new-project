  ...
  return (
    <main className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute top-8 right-10 md:right-16 z-20 flex items-center gap-3">
       ...
       <div className="absolute bottom-40 md:bottom-20 w-120 -translate-y-1/2 right-6 space-y-3 md:space-y-5 sm:right-10 lg:right-25 z-20  max-w-xs sm:max-w-md lg:max-w-xl text-white flex flex-col">    
 <div>
